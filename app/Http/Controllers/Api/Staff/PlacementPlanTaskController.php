...
class PlacementPlanTaskController extends Controller
{
    ...
    public function comment_list(Request $req){
        try{
            ...
            $taskCommentRecord = PlacementPlanComment::select('id','su_placement_plan_id','user_id','comments','created_at')->where(['user_id'=>$req->user_id,'su_placement_plan_id'=>$req->task_id,'is_deleted'=>0])->get();
