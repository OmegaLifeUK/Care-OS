...
@section('content')
                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                ...
                                <button type="button" class="btn btn-primary m-10 openIncidentTypeModal"
                                    data-form-type="add" style="float:right;">Add Safeguarding Type</button>
                                <div class="space15"></div>

                                <div class="row">
                                    <div class="col-lg-6">
                                        <div id="editable-sample_length" class="dataTables_length">
                                            <form method='post' action="{{ url('admin/incident-type') }}"
                                    ...
                                    <div class="col-lg-6">
                                        <form method='get' action="{{ url('admin/safeguarding-type') }}">
                                            ...
                                            @forelse($incidentType as $key=>$label)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        |
                                                        <a href="{{ url('admin/safeguarding-type/delete/' . $label->id) }}"
                        ...
                        <div class="modal-body">
                            <form id="incidentTypeForm">
                                <div class="form-group">
                                    ...
                                    <label class="">Safeguarding Type<span class="radStar ">*</span></label>
                                    <input type="text" name="type" class="form-control checkVali"
                                        placeholder="Enter Safeguarding Type" id="type">
                                </div>
                                <div class="form-group">
    ...
    <script>
        function status_change(id, status) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('admin/safeguarding-type/status-change') }}",
                data: {
                    id: id,
                    status: status,
                    _token: token
        ...
        $(document).on('click', '.openIncidentTypeModal', function() {
            ...
            if (formType === 'add') {
                $("#incidentTypeTitle").text("Add Safeguarding Type");
                $("#incidentTypeForm")[0].reset();
            } else if (formType === 'edit') {
                $("#incidentTypeTitle").text("Edit Safeguarding Type");
        ...
        $(document).on('click', '#saveChanges', function() {
            ...
            var url = "{{ url('admin/safeguarding-type/add/') }}";
            if (incidentType_id) {
                url = "{{ url('admin/safeguarding-type/edit/') }}";
            }
            var token = '<?php echo csrf_token(); ?>'
            var error = false;
