						...
						<tbody>
							<tr>
								<td style="padding-top: 20px;text-align: center;">
									<h2 style="color:#0877BD;margin:0;text-decoration:uppercase;">Hello {{ ucfirst($manager_name) }},</h2>
								</td>
							</tr>
							<tr>
								<td style="padding:0 20px;">
									<p style="color:rgb(51, 51, 51);">Please verify the details of staff user {{ucfirst($user_name)}}. Email Id: {{$user_email}}</p>
									<!-- <p style="color:rgb(51, 51, 51);">Details are shown below:</p>
									
									<p style="color:rgb(51, 51, 51);"><b>Title: </b> </p>
									<p style="color:rgb(51, 51, 51);"><b>Details: </b></p> -->
