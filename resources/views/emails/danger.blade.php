						...
						<tbody>
							<tr>
								<td style="padding-top: 20px;text-align: center;">
									<h2 style="color:#0877BD;margin:0;text-decoration:uppercase;">Hi {{ ucfirst($staff_user_name) }}</h2>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								@if($email_type == "IN_DANGER")
									<p style="color:red">{{ ucfirst($service_user_name) }} {{$request}}</p>
								@endif
								@if($email_type == "REQ_CALLBACK")
									<p style="color:rgb(51, 51, 51);">{{ ucfirst($service_user_name) }} {{$request}}</p>
								@endif
