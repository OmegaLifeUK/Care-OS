						...
						<tbody>
							<tr>
								<td style="padding-top: 20px;text-align: center;">
									<h2 style="color:#0877BD;margin:0;text-decoration:uppercase;">Hello {{ ucfirst($name) }},</h2>
								</td>
							</tr>
							<tr>
								<td style="padding:0 20px;">
									<p style="color:rgb(51, 51, 51);">You are selected for the training.</p>
									<p style="color:rgb(51, 51, 51);">Details of the training is shown below:</p>

									<p style="color:rgb(51, 51, 51);"><b>Training Name:</b> {{ $training_name }}</p>
									<p style="color:rgb(51, 51, 51);"><b>Trainer:</b> {{ $training_provider }}</p>
									<p style="color:rgb(51, 51, 51);"><b>Training Month:</b> {{ $training_month }}</p>
									<p style="color:rgb(51, 51, 51);"><b>Training Year:</b> {{ $training_year }}</p>
									<p style="color:rgb(51, 51, 51);"><b>Training Desc:</b> {{ $training_desc  }}</p>
								</td>
							</tr>
						</tbody>
					</table>
