						...
						<tbody>
							<tr>
								<td style="padding:0 20px;">
									<!-- <p style="color:red"> $service_user_name complaint_message</p> -->
									<p style="color:rgb(51, 51, 51);"><b>{{ ucfirst($service_user_name) }}</b> has made a complaint. </p>
									<p style="color:rgb(51, 51, 51);"><b>Following are the complaint details:</b> </p>
									<p style="color:rgb(51, 51, 51);">{{$complaint_message}}</p>
								</td>
							</tr>
						</tbody>
					</table>
