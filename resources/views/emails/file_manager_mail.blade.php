						...
						<tbody>
							<tr>
								<td style="padding-top: 20px;text-align: center;">
									<h2 style="color:#0877BD;margin:0;text-decoration:uppercase;">Hello {{ ucfirst($member_name) }},</h2>
								</td>
							</tr>
							<tr>
								<td style="padding:0 20px;">
									<p style="color:rgb(51, 51, 51);">For "{{ ucfirst($yp_name) }}" having the following file:</p>
								</td>
							</tr>
							<tr>
								<td style="padding:0 20px;">
									<p style="color:rgb(51, 51, 51);">
										<a href="{{ $file_attached }}">{{ $file_info }}</a>
									</p>
								</td>
							</tr>
						</tbody>
