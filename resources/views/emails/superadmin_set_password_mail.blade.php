					...
					<table>
						<tr>
							<td style="width:20%;padding:0;" >
								<a href="" style="display:block;margin:10px 0;"><img src="{{ asset('public/images/scits.png') }}" style="width: 90px;display:inline-block;width: 100%;" width="20"></a>
							</td>
						</tr>
					</table>
				</td>
						...
						<tbody>
							...
							<tr>
								<td style="padding:0 20px;">
									<p>We are excited to have you get started.Your Username is <span style="color:#0877bd;">{{ $user_name }}</span>. You need to setup your password. Just press the button below.</p>
								</td>
							</tr>
						</tbody>
					</table>
						...
						<tbody>
							<tr>
								<td style="background-color:#fff;text-align:left;padding:20px;">
									<a href="{{ $set_password_url }}" style="font-size:16px;box-shadow:0 1px 2px 1px rgba(0, 0, 0, 0.2);background-color: #0877BD;color: #fff;text-decoration: none;padding: 10px 50px;">Create a Password</a>
								</td>
							</tr>
						</tbody>
					</table>
                                ...
                                */
								...
								<td style="background-color:#333;color:#333;text-align:center;padding:0 20px;">
									<ul type="none" style="padding:0;">
										<li style="display:inline-block;margin-right:5px;"><a href="{{$facebook_slug}}"><img src="{{ asset('public/images/facebook.png') }}" style="width:30px;" width="30"></a></li>
										<li style="display:inline-block;margin-right:5px;"><a href="{{$twitter_slug}}"><img src="{{ asset('public/images/twitter.png') }}" style="width:30px;" width="30"></a></li>
										<li style="display:inline-block;margin-right:5px;"><a href="{{$google_slug}}"><img src="{{ asset('public/images/googleplus.png') }}" style="width:30px;" width="30"></a></li>
