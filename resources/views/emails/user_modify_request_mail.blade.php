						...
						<tbody>
							<tr>
								<td style="padding-top: 20px;text-align: center;">
									<h2 style="color:#0877BD;margin:0;text-decoration:uppercase;">Hello {{ ucfirst($admin_name) }},</h2>
								</td>
							</tr>
							<tr>
								<td style="padding:0 20px;">
									<p style="color:rgb(51, 51, 51);">You have got a Modification request</p>
									<p style="color:rgb(51, 51, 51);">Details are shown below:</p>
									
									<p style="color:rgb(51, 51, 51);"><b>User name:</b> {{ Auth::user()->user_name }}</p>
									<p style="color:rgb(51, 51, 51);"><b>Action:</b> {{ $action }}</p>
									<p style="color:rgb(51, 51, 51);"><b>Content:</b> {{ $content }}</p>
									<p style="color:rgb(51, 51, 51);"><b>Reason</b> {{ $reason }}</p>
