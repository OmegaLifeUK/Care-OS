					...
					<table>
						<tr>
							<td style="max-width:400px;padding:0;" >
								<a href="" style="display:block;margin:10px 0;"><img src="{{ asset('public/images/scits-150.png') }}" style="max-width: 90px;display:inline-block;width: 100%;"></a>
							</td>
						</tr>
					</table>
				</td>
						...
						<tbody>
							<tr>
								<td style="background-color:#fff;text-align:left;padding:20px;">
									<a href="{{ $set_password_url }}" style="font-size:16px;box-shadow:0 1px 2px 1px rgba(0, 0, 0, 0.2);background-color: #0877BD;color: #fff;text-decoration: none; padding-top: 10px; padding-bottom: 10px; padding-right: 50px; padding-left:50px;">Create a Password</a>
								</td>
							</tr>
						</tbody>
					</table>
							...
							<tr>
                                ...
                                */
								...
								<td style="background-color:#333;color:#333;text-align:center;padding:0 20px;">
									...
									<a href="{{$facebook_slug}}"><img src="{{ asset('public/images/facebook.png') }}" style="max-width:30px;"></a>
									<a href="{{$twitter_slug}}"><img src="{{ asset('public/images/twitter.png') }}" style="max-width:30px;"></a>
									<a href="{{$google_slug}}"><img src="{{ asset('public/images/googleplus.png') }}" style="max-width:30px;"></a>
