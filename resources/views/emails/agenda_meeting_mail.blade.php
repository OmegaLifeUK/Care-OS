						...
						<tbody>
							...
							<tr>
								<td style="padding:0 20px;">
									<p style="color:rgb(51, 51, 51);">You have got Agenda Meeting Details</p>
									<p style="color:rgb(51, 51, 51);">Details are shown below:</p>
									
									<!-- <p style="color:rgb(51, 51, 51);"><b>User name:</b> {{ $user_name }}</p> -->
									<p style="color:rgb(51, 51, 51);"><b>Title:</b> {{ $title }}</p>
									<p style="color:rgb(51, 51, 51);"><b>Notes:</b> {{ $notes }}</p>
								</td>
							</tr>
						</tbody>
					</table>
