...
<body style="margin: 0px; padding-bottom: 50px; padding-left: 0; padding-right: 0;font-family:sans-serif;background-color:#ebebeb;">
	...
	<table style="width: 100%;" cellspacing="0" cellpadding="0">
		<tbody>
						...
						<tbody>
							<tr>
								<td style="padding-top: 20px;text-align: center;">
									<h2 style="color:#0877BD;margin:0;text-decoration:uppercase;">Hi {{ ucfirst($user_name) }}</h2>
								</td>
							</tr>
						</tbody>
					</table>
			...
			<tr>	
				<td valign="top" align="center" style="background-color:#fff;">
					<table style="text-align: left; background-color:#fff;border-radius:4px 4px 0 0;color: rgb(51, 51, 51); font-size:16px;width:100%;max-width:650px;"  cellspacing="0">
						<tbody>
							<tr>
								<td style="padding:0 20px;">
									<p style="color:rgb(51, 51, 51);">We have updated the following policy & procedures. </p>
									<p style="color:rgb(51, 51, 51);">{{ ucfirst($policy_name) }}</p>
									<p style="color:rgb(51, 51, 51);">
										The Policies & Procedures are the legally binding agreement that Scits wants you to read and agree.
									</p>
									<p style="color:rgb(51, 51, 51);">Please read it carefully and accept it</p>
									<a style="color:#fff;text-decoration:none;background-color:#0877bd;" href="{{ url('/') }}"> <button style="color:#fff;background-color:#0877bd;padding:5px 10px;border-radius:4px;border:1px solid #0877bd;cursor:pointer;"> Click here to Accept</button></a>
									<p style="color:rgb(51, 51, 51);">Thanks</p>
								</td>
							</tr>
						</tbody>
					</table>
