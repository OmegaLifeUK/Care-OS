						...
						<tbody>
							<tr>
								<td style="padding-top: 20px;text-align: center;">
									<h2 style="color:#0877BD;margin:0;text-decoration:uppercase;">Hi {{ ucfirst($admin_name) }}</h2>
								</td>
							</tr>
						</tbody>
					</table>
						...
						<tbody>
							<tr>
								<td style="padding:0 20px;">
									<p style="color:rgb(51, 51, 51);">{{ ucfirst($user_name) }} has accept the "{{ ucfirst($policy_file) }}" policy | {{ date('d M Y h:i a', strtotime($accepted_time)) }}</p>
									<p style="color:rgb(51, 51, 51);">
										<?php $file = PoliciesFilePath.'/'.$policy_file;?>
										You can click on this link to view
                                        <a href="{{ $file }}"> Policy</a>
									</p>
